<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseKarya" aria-expanded="true" aria-controls="collapseKarya">
      <i class="fa fa-book"></i>
      <span>Karya Tulis</span>
    </a>
    <div id="collapseKarya" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="<?php echo base_url() . 'admin/karya' ?>">List Karya Tulis</a>
        <a class="collapse-item" href="<?php echo base_url() . 'admin/karya/comment_control' ?>">Kelola Komentar</a>
      </div>
    </div>
  </li>
  <!-- Divider -->
